...
1. **試験範囲の把握** — [00-exam-guide](./00-exam-guide/README.md) で全体像とタスクステートメントを確認
2. **ドメイン別学習** — 配点の大きい順(02 → 01 → 03 → 04)にノートを読み込む。各ノートは「試験で問われる観点 → 設計パターン → トレードオフ比較表 → ひっかけポイント」の構成
3. **模擬試験・問題演習** — AWS Skill Builder の公式練習問題や市販の模試で弱点を特定し、該当ノートに戻る
4. **直前対策** — [05-cheatsheets](./05-cheatsheets/README.md) で要点と使い分けを総復習
